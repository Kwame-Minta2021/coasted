...
export default function Navbar() {
  ...
  return (
    <header className="sticky top-4 z-50 transition-all duration-300 bg-white/30 cc-glass dark:bg-slate-950/30 rounded-2xl mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
      ...
      {isClient && isMobileMenuOpen && (
        <div className="md:hidden">
          <div className="px-2 pt-2 pb-3 space-y-1 bg-white/80 dark:bg-slate-900/80 backdrop-blur-sm rounded-xl mt-4 border border-slate-200/50 dark:border-slate-700/50">
            <Link 
              href="/" 
