...
export default function StudentLoginPage() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Use Supabase Auth for student login
      ...
      if (error) {
        ...
        setMessage('Login successful! Redirecting to student portal...');
  ...
  if (isClient && user) {
  return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 relative overflow-hidden">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-purple-50 to-indigo-100 dark:from-slate-900 dark:via-slate-800 dark:to-slate-900 relative overflow-hidden">
      ...
      <div className="absolute bottom-20 right-20 w-40 h-40 bg-purple-200/20 dark:bg-purple-400/10 rounded-full blur-xl animate-pulse delay-1000"></div>
      <div className="absolute top-1/2 left-10 w-24 h-24 bg-indigo-200/20 dark:bg-indigo-400/10 rounded-full blur-xl animate-pulse delay-500"></div>
          ...
          <div className="max-w-lg">
            ...
            <div className="mb-16">
              ...
              <p className="text-xl text-slate-600 dark:text-slate-400 leading-relaxed mb-12">
                Continue your coding journey and unlock new possibilities in the world of technology.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900 dark:text-white">Interactive Learning</h3>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Engage with hands-on coding exercises</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
                ...
                <div>
                  <h3 className="font-semibold text-slate-900 dark:text-white">Community Support</h3>
                  <p className="text-sm text-slate-600 dark:text-slate-400">Connect with fellow learners</p>
                </div>
              </div>
              <div className="flex items-center gap-4">
            ...
            <div className="bg-white/90 dark:bg-slate-800/90 backdrop-blur-2xl rounded-3xl shadow-2xl border border-white/30 dark:border-slate-700/50 p-10 relative overflow-hidden">
              ...
              <div className="relative">
                <div className="text-center mb-10">
                  ...
                  <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-3">Student Portal</h2>
                  <p className="text-slate-600 dark:text-slate-400 text-lg">Sign in to continue learning</p>
                </div>
